...
public class ProductFlagController {
	 ...
	 */
	@GetMapping(value = "/products-flag")
	List<ProductFlag> getAllProductsFlag() {
		return productFlagService.findAll();
	}
	
	/**
	 * Método que inserta un productFlag.
	 * @param productFlag El parámetro productFlag es el objeto product que se insertará en BBDD.
	 ...
	 * @param productFlag El parámetro productFlag es el objeto product que se actualizará en BBDD.
	 ...
	 * @param id El parámetro id es el identificador del productFlag que se quiere eliminar.
